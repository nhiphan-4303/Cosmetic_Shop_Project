 ...
 */ (function (global, factory) {
  ...
  const Default$a = { toggle: true, parent: null };
  const DefaultType$a = { toggle: "boolean", parent: "(null|element)" };
  ...
  const Default$7 = { trapElement: null, autofocus: true };
  const DefaultType$7 = { trapElement: "element", autofocus: "boolean" };
  ...
  const Default$6 = { backdrop: true, keyboard: true, focus: true };
  const DefaultType$6 = {
  ...
  const Default = { animation: true, autohide: true, delay: 5000 };
