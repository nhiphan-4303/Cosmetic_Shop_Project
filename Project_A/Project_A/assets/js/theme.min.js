...
(function (e) {
  ...
  (function (e) {
    ...
    (APP.animation = {
      ...
      registerAnimation: function () {
        var t = this;
        e("[data-animate]:not(.animate__animated)", t.$wrapper).waypoint(
          function () {
            var s,
              o,
  ...
  (() => {
    ...
    const t = new ClipboardJS(".btn-clipboard", {
      target: (e) =>
        e.closest(".doc-code-snippet").querySelector(".doc-example-markup"),
    });
    t.on("success", (t) => {
  ...
  (function () {
    ...
    APP.core = {
      ...
      isDeviceUp: function (e) {
        return window.matchMedia("(min-width: " + APP.core._devices[e] + "px)")
          .matches;
      },
      ...
      e(document).on("hide.bs.dropdown", function (n) {
        ...
        e(n.target)
          ...
          e(n.target).closest(".nav-item") &&
            ...
            (n.clickEvent === void 0 ||
              (n.clickEvent && n.clickEvent.target === n.target)) &&
    ...
    (APP.fullPageScroll = {
      ...
      init: function () {
        ...
        if (
          ...
          this.$_dots.length === 0 &&
            ((this.$_dots = e('<div class="full-page-dots"></div>')),
        ...
        document.addEventListener("mousedown", function (e) {
          ...
          window.addEventListener("wheel", function (e) {
            if (
              ...
              (APP.fullPageScroll._activeSlide += e.deltaY > 0 ? 1 : -1),
              ...
              APP.fullPageScroll._activeSlide >
                ...
                (APP.fullPageScroll._activeSlide =
                  APP.fullPageScroll._slides.length),
              APP.fullPageScroll._activeSlide === APP.fullPageScroll._oldSlide)
            )
              return;
              ...
              c - a < n
                ? (o.css("position", "fixed"),
                  ...
                  o.hasClass("unset-mode-when-sticky") &&
                    ...
                    this.bs_theme !== void 0 && o.removeAttr("data-bs-theme")),
                  s &&
            ...
            : e(".header-sticky-smart .sticky-area").each(function () {
                ...
                t.length &&
                  APP.headerSticky.scroll_offset_before >
                    t.offset().top + e(this).outerHeight() &&
                  !e(this).hasClass("header-hidden") &&
    ...
    (APP.lazyLoad = {
      ...
      update: function () {
        e(".lazy-image").each(function () {
          ...
          this.instanceBackground !== null && this.instanceBackground.update();
      },
    }),
      e(document).ready(function () {
        APP.lazyLoad.init();
      ...
      init: function () {
        ...
        (n = {
          ...
          t.each(function () {
            ...
            (o.container = a),
              (mapboxgl.accessToken = s.data("mapbox-access-token")),
              ...
              i.length > 0
                ...
                : e.each(c, function () {
                    ...
                    (e.className = this.className),
                      ...
                      (e.style.backgroundRepeat = this.backgroundRepeat),
      ...
      slickSetup: function (n) {
        ...
        var t,
          s = {
            ...
            vertical: !1,
            prevArrow:
              '<div class="slick-prev" aria-label="Previous"><svg class="icon"><use xlink:href="#icon-chevron-left"></use></svg></div>',
            nextArrow:
            ...
            n.hasClass("our-best-seller-4") &&
              (t.customPaging = function (t, n) {
                ...
                return (
                  n < 9 ? (s = n + 1) : (s = n + 1),
                  (e = ""),
                  t.slideCount < 9 ? (e = t.slideCount) : (e = t.slideCount),
        ...
        e('[data-bs-toggle="tab-accordion"] [data-bs-toggle="tab"]').on(
          ...
          function (t) {
            ...
            s.find(".collapse").addClass("show"),
              ...
              s.find('[data-bs-toggle="collapse"]').removeClass("collapsed"),
              o.find('[data-bs-toggle="collapse"]').addClass("collapsed");
          }
        ),
          e('[data-bs-toggle="tab-accordion"] .collapse').on(
            ...
            function (i) {
              ...
              s.length &&
                ((t = e('[data-bs-target="#' + s.attr("id") + '"]')),
                t.length &&
                  ((n = t.closest(".nav-tabs")),
                  n.length &&
                    (n.find('[data-bs-toggle="tab"]').removeClass("active"),
                    (o = n.next(".tab-content")),
                    o.length && o.find(".tab-pane").removeClass("show active"),
        ...
        e('[data-bs-toggle="tab-dropdown"] [data-bs-toggle="tab"]').on(
          ...
          function (n) {
            ...
            t.find('[data-bs-toggle="tab"]').removeClass("active"),
              t.find('[data-bs-target="' + o + '"]').addClass("active"),
              t.find('[data-bs-toggle="dropdown"]').text(s.text());
          }
        );
      },
    }),
